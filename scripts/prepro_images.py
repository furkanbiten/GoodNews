...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='../data/data_news.json', help='input json file to process into hdf5')
  parser.add_argument('--output_h5', default='../data/data_news', help='output h5 file')
  
  # options
  parser.add_argument('--images_root', default='../resized/', help='root location in which images are stored, to be prepended to file_path in input json')
