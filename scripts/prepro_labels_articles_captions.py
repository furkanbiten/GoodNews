...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='../data/news_dataset.json',
                      help='input json file to process into hdf5')
  parser.add_argument('--input_article_json', default='../data/article.json',
                      help='input json file to process into hdf5')
  parser.add_argument('--output_json', default='../data/data_news_full.json', help='output json file')
  parser.add_argument('--output_h5', default='../data/data_news_full', help='output h5 file')
